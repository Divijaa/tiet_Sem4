...
simptable.Properties.VariableNames(1:size(zcj,2))=  {'x_1','x_2','s1','s2','A3','b'}
...
if any(zc<0);
    ...
    if all(A(:,pvt_col)<=0)
        ...
        table.Properties.VariableNames(1:size(zcj1,2))= {'x_1','x_2','s1','s2','A3','b'}
        ...
        curr_Bfs.Properties.VariableNames(1:size(curr_Bfs,2)) =  {'x_1','x_2','s1','s2','A3','b'}
